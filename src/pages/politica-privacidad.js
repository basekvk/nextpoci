...
function politicaPrivacidad({ newsletterItems, footerItems }) {
    return (
        <>
            <Head>
                <title>Política Privacidad - Desatascos y Poceros</title>
                <meta
                    name="description"
                    content="Aquí podras encontrar todo lo referente a la política de privacidad de la web de Desatascos Pociten"
                />
                <link rel="canonical" href="https://www.desatascos-madrid.com/politica-privacidad"/>
            </Head>
            <Breadcrumb
